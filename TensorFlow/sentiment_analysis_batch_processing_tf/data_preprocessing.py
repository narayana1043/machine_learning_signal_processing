...
Download the zip file from: http://help.sentiment140.com/for-students/
'''

def init_process(fin, fout):
    '''
    We're modifying the sentiment label, and some of the formatting.
    :param fin:
    :param fout:
    :return:
    '''
...
def create_lexicon(fin):
    '''
    lexicon is based on a random one out of every 2500 samples that we have, to get a random sampling
    :param fin:
    :return:
    '''
    lexicon = []
